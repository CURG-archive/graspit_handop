...
public:
  ...
  */
  ...
  void getGeometryVertices(std::vector<position> *vertices) const;
    /*! Returns all the vertices of the scene graph geometry of this object in world coordinates*/
  void getGeometryVerticesInWorldCoordinates(std::vector<position> *vertices) const;
