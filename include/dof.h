...
public:
  ...
  /*! Sets the number of this DOF */
  void setDOFNum(int newDOFNum){dofNum = newDOFNum;}
  ...
  float getDraggerScale() const {return draggerScale;}
    /*! Sets the dragger scale for this DOF */
  void setDraggerScale(float newDraggerScale){draggerScale = newDraggerScale;}
  ...
  void setMaxEffort(double effort){maxForce = effort;}  
  void setKp(double newKp){Kp = newKp;}
  void setKv(double newKv){Kv = newKv;}
