...
GuidedPlanner::GuidedPlanner(Hand *h)
{
	...
	mMinChildEnergy = 25;//-0.1f;
	mChildEnergyType = CONTACT_GFO;//ENERGY_STRICT_AUTOGRASP;
	mMaxChildSteps = 200;
...
GuidedPlanner::mainLoop()
{
	...
	//SimAnn::Result r = mSimAnn->iterate(mCurrentState, mEnergyCalculator, NULL, mHand->getWorld()->getRobot(1));
