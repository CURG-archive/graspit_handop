...
public:
  ...
  GenericGraspPlanningTask(TaskDispatcher *disp, db_planner::DatabaseManager *mgr, 
			   db_planner::TaskRecord rec, EGPlannerFactory * egplannerFactory, const int taskNum):  GraspPlanningTask(disp, mgr, rec), mPlannerFactory(*egplannerFactory), saver(mgr,taskNum){};	
