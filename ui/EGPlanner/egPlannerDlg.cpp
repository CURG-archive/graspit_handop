...
{ 
 ...
 energyBox->insertItem("GFO Energy");
 energyBox->insertItem("Contact GFO Energy");
...
void EigenGraspPlannerDlg::readPlannerSettings()
{
 ...
 }else if (s == QString("GFO Energy") ){
     mPlanner->setEnergyType(ENERGY_GFO);
 }else if (s == QString("Contact GFO Energy") ){
     mPlanner->setEnergyType(CONTACT_GFO);
 } else {
